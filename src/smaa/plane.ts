...
export class SMAAPlane {
    ...
    constructor(gl: WebGLRenderingContext, size: number[]) {
        ...
        this.pass1Program = new ShaderProgram({
        ...
        this.pass2Program = new ShaderProgram({
            vertex: new Shader('vertex', vertexCode2),
            fragment: new Shader('fragment', fragmentCode2),
            uniforms: [
                {name: 'resolution', type: '2f'},
                {name: 'tDiffuse', type: '1i'},
                {name: 'tArea', type: '1i'},
        ...
        this.pass3Program = new ShaderProgram({
            vertex: new Shader('vertex', vertexCode3),
            fragment: new Shader('fragment', fragmentCode3),
            uniforms: [
                {name: 'resolution', type: '2f'},
                {name: 'tDiffuse', type: '1i'},
                {name: 'tColor', type: '1i'},
